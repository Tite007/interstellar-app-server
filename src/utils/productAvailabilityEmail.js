        ...
        <tr>
          <td style="padding: 24px;">
            ...
            <p style="text-align: center; margin: 20px 0;">
              <a href="${productUrl}" style="background-color: #4F46E5; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-size: 16px;">Buy ${productName}</a>
            </p>
